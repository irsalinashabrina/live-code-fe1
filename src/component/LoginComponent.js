...
class LoginComponent extends Component {
    ...
    handleEmailChange = (event) => {
        if (event.target.value.includes('@')){
            ...
            this.setState({
                emailValid : false,
                labelEmail: 'Username tidak memiliki \'@\''
            })
        }
    }
                ...
                <form onSubmit={this.handleSubmit}>
                   <div style={loginForm}>
                       <div style={loginFormItem}>
                           <label>email</label>
                           <input style={input} type="email" placeholder="email" onChange={this.handleEmailChange} value={this.state.email} required/>
                           <p style={warning}>{this.state.labelEmail}</p>
                       </div>
                       <div style={loginFormItem}>
                           <label>Password</label>
                           <input style={input} type="password" placeholder="password" onChange={this.handleChangePassword} value={this.state.password} required/>
                           <p style={warning}>{this.state.labelPassword}</p>
                       </div>
